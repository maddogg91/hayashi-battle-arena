        ...
        <div className="panel p-5 sm:p-6">
          ...
          {showWhatsNew && (
            <ul className="mt-3 text-sm text-slate-300 space-y-1.5 list-disc list-inside">
              <li>Balance pass: Liara's Sonic Edge costs less (50→40 SP) and hits harder (25→45 dmg). Ben's Fist of the King can no longer be recast while already active. Sai's Binding Chain now costs him 25 recoil damage to use. Kairu's Imbue with Light dodge chance reduced 50%→25%. Arthur's Direct Shot deals less (40→30, 55→45 with Lock-on). Sora's Wave Runner evasion reduced 50%→25%.</li>
