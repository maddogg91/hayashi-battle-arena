        ...
        <div className="panel p-5 sm:p-6">
          ...
          {showWhatsNew && (
            <ul className="mt-3 text-sm text-slate-300 space-y-1.5 list-disc list-inside">
              ...
              <li>Four more unlockable characters: Raven (AERO) — Shadow Crawl, Swift Strikes, Quick Retreat, Desperate Lunge, unlocked via 20 wins with Liara Mitsuke; Caine (Flame) — a strict Un!/Deux!/Trois!/Crimson Finale! combo chain, unlocked via a 5-win streak specifically while playing Teru Fukuzawa; Ivy Al Vere (Celestial) — Sendara's long-missing sister, Lightning Spear, Oppressive Spirit, Concentrated Barrage, Abandon Principles, unlocked via 20 wins with Sendara Al Vere; Lance (Mist) — Lyra's long-lost older brother, Darkness Flames, Doppelganger, Refresh, Gugnir, unlocked via 10 wins with Lyra plus 5 wins each with Kairu, Soren, and Arthur.</li>
              <li>Three new unlockable Junior Instructors, each requiring Junior Instructor rank (1,000 career wins) plus 10 wins with a specific character and a 10-match win streak: Rock West (Celestial) — Substitution, Clone Technique, Shuriken Barrage, Gale of Devastation, unlocked via Star Trethowan; Teru Fukuzawa (AERO) — Scout Target, Quick Shot, Gunplay Carnival, Final Act, unlocked via Jett Kimura; Leia Claasen (Flame) — Almighty Charge, Bullish Cutter, Absolute Refusal, Intimidation, unlocked via Sendara Al Vere. Yuka has also been corrected to Terra Guild and given a fully reworked kit: Mouse Trap, Age Hex, Body Swap, and Topsy-turvy Ordeal.</li>
              <li>New: Ranks (based on career wins, from Academy Prospect up to Headmaster) and a Missions page for registered users. The roster now supports locked, unlockable characters — shown as a "🔒 ???" card until earned.</li>
